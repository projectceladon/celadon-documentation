...
Andoird 11: Comet Lake (CML), Tiger Lake (TGL), and Elkhart Lake (EHL) platforms with a single Baseline/Image
Andoird 12: Alder Lake (ADL) platforms with a single Baseline/Image of 
